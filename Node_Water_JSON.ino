...
const char* mqtt_server = "192.168.1.4";  // Change this to your EMQX server IP
...
void sendDataToMQTT(float tdsValue, float temperature, float turbidityValue) {
...
void loop() {
  ...
  sendDataToMQTT(tdsValue, temperature, 0.0);
